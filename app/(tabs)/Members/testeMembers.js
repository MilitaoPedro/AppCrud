...
import Animated, { useAnimatedStyle, withTiming, interpolate, useSharedValue, useDerivedValue } from "react-native-reanimated";
...
export default function TesteMembers( {navigation, name, numMatricula} ){
